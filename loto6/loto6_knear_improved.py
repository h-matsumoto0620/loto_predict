...
# ============================================================
# 各数字列ごとにKNeighborsRegressorで学習・予測
# 修正⑦: scoring="neg_mean_squared_error" を明示
#   元コードはscoringを指定しておらずデフォルトR²が使われていた
#   回帰の評価としてMSEの方が直感的で一貫性がある
# ============================================================
...
for col_idx in range(6):
    ...
    grid = GridSearchCV(
        ...
        param_grid,
        cv=tscv,
        scoring="neg_mean_squared_error",  # 修正⑦
        n_jobs=-1,
    )
    ...
    print(f"  第{col_idx+1}数字: 予測={pred:2d}  "
          f"(n_neighbors={best_model.n_neighbors}, weights={best_model.weights})")
