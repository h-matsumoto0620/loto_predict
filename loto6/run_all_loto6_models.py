...
# ============================================================
print(f"{'='*55}")
print(f"  STEP0: ロト6 CSV更新")
print(f"{'='*55}")
try:
    result = subprocess.run(
        [sys.executable, "update_loto6_csv.py"],
    ...
    print("  スキップ: update_loto6_csv.py が見つかりません。")
    print("  CSV更新をスキップして予測処理を続行します。")
...
# ============================================================
scripts = [
    ("K-近傍法 (KNN)",          "loto6_knear_improved.py"),
    ("MLP（ニューラルネット）",   "loto6_mlp_improved.py"),
    ("ランダムフォレスト",        "loto6_random_improved.py"),
