...
# ============================================================
# 各数字列ごとにSVR（RBFカーネル）で学習・予測
# 修正⑦: gammaの探索範囲を追加（"scale"はSklearnの推奨デフォルト）
# ============================================================
tscv = TimeSeriesSplit(n_splits=5)
param_grid = {
    "C": [1, 10, 100],
    "gamma": ["scale", 0.01, 0.1, 1],  # "scale"を追加
    "epsilon": [0.1, 0.2],
}
...
for col_idx in range(6):
    ...
    print(f"  第{col_idx+1}数字: 予測={pred:2d}  (C={best_model.C}, gamma={best_model.gamma}, epsilon={best_model.epsilon})")
